...
//       console.log(`\x1B[30m${new Date().format("yyyy-MM-dd hh:mm:ss")}\x1B[0m \x1B[33m[create.examples]\x1B[0m \x1B[0m\x1B[32m${dir}/dataBase.ts\x1B[0m`)
//       execSync("bun add mongoose")
...
//       console.log(`\x1B[30m${new Date().format("yyyy-MM-dd hh:mm:ss")}\x1B[0m \x1B[33m[create.examples]\x1B[0m \x1B[0m\x1B[32m${dir}/model.ts\x1B[0m`)
